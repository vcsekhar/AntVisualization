...
public class PreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    public PreferencePage() {
        ...
        setDescription("Ant Visualization Preferences");
    }
    ...
    public void createFieldEditors() {
        addField(new FileFieldEditor(PreferenceConstants.USER_EXECUTABLE_PATH, "User E&xecutable:", getFieldEditorParent()));
...
//                { "&Choice 1", "choice1" }, { "C&hoice 2", "choice2" } }, getFieldEditorParent()));
        addField(new StringFieldEditor(PreferenceConstants.USER_EXECUTABLE_ARG, "User &Argument:", getFieldEditorParent()));
    }
